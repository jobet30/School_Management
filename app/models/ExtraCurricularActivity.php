...
class ExtracurricularActivity {
    ...
    public function create($data) {
        $sql = "INSERT INTO extracurricular_activities (name, description) VALUES (:name, :description)";
    ...
    public function update($id, $data) {
        $sql = "UPDATE extracurricular_activities SET name = :name, description = :description WHERE id = :id";
        $stmt = $this->pdo->prepare($sql);
        $data[':id'] = $id;
        return $stmt->execute($data);
    }
